      ...
      <div class="contents-inner">
        <div class="contents-container container-md">
          ...
          <div id="myPage-reviewListDiv">
          	<form action="myReviewListForm">
	          <div class="contents-search">
	          	<c:set var="totalCount" value="${ fn:length(rList) }" />
	            <p class="contents-result"> 전체<span> ${ revListCount }</span>개 </p>
	          ...
	          <div class="tableset">
	            <table class="tableset-table table" id="reviewTable">
	              <colgroup>
	                <col>
	                <col>
	                <col>
				...
				<c:if test="${ revPi.currentPage > 1 }">
					<div class="pagiset-ctrl">
						<c:url var="goFirst" value="${ loc }">
							...
							<c:param name="listType" value="reviewList"/>
						</c:url>
          ...
          <div id="myPage-replyListDiv" style="display: none;">
          	<div class="contents-search">
	            <p class="contents-result"> 전체<span> ${ repListCount }</span>개 </p>
	            <div class="selectDateDiv">
	            	<input type="date">&nbsp;-&nbsp;
	            	<input type="date">
	            </div>
	            ...
	            <table class="tableset-table table" style="table-layout:fixed; width: 100%" id="replyTable">
	              ...
	              <tbody>
	                <c:forEach items="${ pList }" var="p">
		                <tr>
		                  <td class="tableset-mobile">${ p.repNo }</td>
		                  <td class="tableset-proImg">
		                  	<img alt="작품 사진" src="${ p.proImage }">
						  </td>
				...
				<c:if test="${ repPi.currentPage > 1 }">
					<div class="pagiset-ctrl">
						<c:url var="goFirst" value="${ loc }">
							...
							<c:param name="listType" value="replyList"/>
						</c:url>
						<a class="pagiset-link pagiset-first" href="${ goFirst }">
							<span class="visually-hidden">처음</span>
						</a>
...
window.onload = () =>{
	...
	for(const reviewTr of reviewTableTr){
		const revNo = reviewTr.querySelector('#reviewNo').value;
	    revNos.push(revNo);
